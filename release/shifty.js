...
Shifty.UI.Tabs = (function () {
  let labels   = document.querySelector('.tabs-labels'),
...
Shifty.Dot = function (x, y) {
  this.p = new Shifty.Point({
    x: x,
    y: y,
    z: 5,
    a: 1,
  ...
  this.c = new Shifty.Color(255, 255, 255, this.p.a);

  this.t = this.clone();
  this.q = [];
};

Shifty.Dot.prototype = {
  clone: function () {
    return new Shifty.Point({
      x: this.x,
      y: this.y,
      z: this.z,
      a: this.a,
  ...
  _draw: function () {
    this.c.a = this.p.a;
    Shifty.Drawing.drawCircle(this.p, this.c);
  },
  ...
  return {
    ...
    switchShape: function (n, fast) {
      ...
      if (n.dots.length > dots.length) {
        ...
        for (d = 1; d <= size; d++) {
          dots.push(new Shifty.Dot(a.w / 2, a.h / 2));
        }
      }
